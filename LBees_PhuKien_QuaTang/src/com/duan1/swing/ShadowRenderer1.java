...
class ShadowRenderer1 {
    ...
    public ShadowRenderer1() {
        this(5, 0.5f, Color.BLACK);
    }

    public ShadowRenderer1(final int size, final float opacity, final Color color) {
        this.size = size;
    ...
    public BufferedImage createShadow(final BufferedImage image) {
        ...
        GraphicsUtilities1.getPixels(image, 0, 0, srcWidth, srcHeight, srcBuffer);
        ...
        GraphicsUtilities1.setPixels(dst, 0, 0, dstWidth, dstHeight, dstBuffer);
        return dst;
    }
}
