...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/duan1/icon/sucess.png")));
    ...
    private BufferedImage createShadow() {
        ...
        g2.dispose();
        return new ShadowRenderer1(shadowSize, 0.3f, new Color(100, 100, 100)).createShadow(img);
    }
    ...
    private void initComponents() {
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/duan1/icon/close1.png"))); // NOI18N
